...
{
    public function test_melbourne_tourist_calendar_displays_vijay_bhau(): void
    {
        ...
        $this->assertSame('Vijay bhau', $consultant->calendar_type_display);
        $this->assertSame('Vijay bhau', $consultant->crm_display_label);
        $this->assertSame(['Tourist Visa'], $consultant->getSpecializationNames());
    }

    public function test_dashboard_calendar_options_label_tourist_as_vijay_bhau(): void
    {
        ...
        $this->assertSame('Vijay bhau', $labels['tourist']);
    }
}
