...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates client_student_references for Student Visa (500) sheet.
     */
    public function up(): void
    {
        Schema::create('client_student_references', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['client_id', 'client_matter_id'], 'client_student_references_client_matter_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('client_student_references');
    }
};
