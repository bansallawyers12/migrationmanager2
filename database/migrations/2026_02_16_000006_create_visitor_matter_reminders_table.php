...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates visitor_matter_reminders for Visitor Visa Sheet Checklist tab (email/sms/phone reminder audit).
     */
    public function up(): void
    {
        Schema::create('visitor_matter_reminders', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['client_matter_id', 'type'], 'visitor_matter_reminders_matter_type_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('visitor_matter_reminders');
    }
};
