...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates tr_matter_reminders for TR Sheet Checklist tab (email/sms/phone reminder audit).
     */
    public function up(): void
    {
        Schema::create('tr_matter_reminders', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['client_matter_id', 'type'], 'tr_matter_reminders_matter_type_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('tr_matter_reminders');
    }
};
