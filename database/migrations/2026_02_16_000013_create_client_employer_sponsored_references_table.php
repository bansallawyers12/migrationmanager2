...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates client_employer_sponsored_references for Employer Sponsored Visa (482, 494, 186, 407) sheet.
     */
    public function up(): void
    {
        Schema::create('client_employer_sponsored_references', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['client_id', 'client_matter_id'], 'client_emp_sponsored_ref_client_matter_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('client_employer_sponsored_references');
    }
};
