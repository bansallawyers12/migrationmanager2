...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates client_tr_references for TR (Temporary Residence) sheet.
     */
    public function up(): void
    {
        Schema::create('client_tr_references', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['client_id', 'client_matter_id'], 'client_tr_references_client_matter_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('client_tr_references');
    }
};
