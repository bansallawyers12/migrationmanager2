...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates client_pr_references for PR Application (189, 190, 491) sheet.
     */
    public function up(): void
    {
        Schema::create('client_pr_references', function (Blueprint $table) {
            $table->id();
            ...
            $table->unique(['client_id', 'client_matter_id'], 'client_pr_references_client_matter_unique');
        });
    }
    ...
    {
        Schema::dropIfExists('client_pr_references');
    }
};
