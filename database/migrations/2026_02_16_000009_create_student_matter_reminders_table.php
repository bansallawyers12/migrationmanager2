...
return new class extends Migration
{
    /**
     * Run the migrations.
     * Creates student_matter_reminders for Student Visa Sheet Checklist tab (email/sms/phone reminder audit).
     */
    public function up(): void
    {
        Schema::create('student_matter_reminders', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['client_matter_id', 'type'], 'student_matter_reminders_matter_type_idx');
        });
    }
    ...
    {
        Schema::dropIfExists('student_matter_reminders');
    }
};
