/**
 * Account tab — DIBP Receipts panel.
 * Isolated from account-tab.js so company detail (eager Account) can bind
 * Receipts without loading the Account lazy-loader or re-running invoice/ledger init.
 */
(function() {
    'use strict';
