    $(document).ready(function() {
       ...
       // On page load, check if the URL contains a matter ID and set the dropdown/checkbox state
        ...
        $(document).delegate('.tab-button[data-tab="artificialintelligences"], .vertical-tab-button[data-tab="artificialintelligences"], .client-nav-button[data-tab="artificialintelligences"]', 'click', function() { //alert('click');
            ...
            $.ajax({
                url: window.ClientDetailConfig.urls.loadMatterAiData,
                type: 'POST',
                data: {
                    client_id: window.ClientDetailConfig.clientId,
                    client_unique_matter_no: window.ClientDetailConfig.matterRefNo,
                    _token: $('meta[name="csrf-token"]').attr('content')
                },
                success: function(response) {
        ...
        function loadChatHistory() {
            $.ajax({
                url: window.ClientDetailConfig.urls.getChatHistory,
                type: 'POST',
                data: {
                    client_id: window.ClientDetailConfig.clientId,
                    _token: $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).delegate('.chat-history-item', 'click', function() {
            ...
            $.ajax({
                url: window.ClientDetailConfig.urls.getChatMessages,
                type: 'POST',
                data: {
                    chat_id: chatId,
                    _token: $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).delegate('.send-chat-btn', 'click', function() {
            ...
            $.ajax({
                url: window.ClientDetailConfig.urls.sendAiMessage,
                type: 'POST',
                data: {
                    client_id: window.ClientDetailConfig.clientId,
                    message: message,
...
$(document).ready(function() {
   ...
   // Assuming this is part of the rendering logic for Client Funds Ledger entries
    ...
    document.getElementById('enhanceMessageBtn').addEventListener('click', function() {
        ...
        fetch(window.ClientDetailConfig.urls.enhanceMail, {
            method: "POST",
            headers: {
