		...
		if(i > 0)
		...
		else
			{
				...
				var noteid = $('#appnotetermform input[name="noteid"]').val();
					...
					// Old taskform removed - Task table/model no longer existselse if(formName == 'tasktermclientform'){
				...
				// servicefeeform handler REMOVED - form/modals no longer exist; /agent/get-services route removed
				...
				// Modals/forms removed; /agent/get-services route removed; Interested Services feature deprecated
