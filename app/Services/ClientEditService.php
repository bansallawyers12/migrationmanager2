...
class ClientEditService
{
    ...
    {
        return Admin::with(['partner', 'company.contactPerson', 'company.tradingNames', 'company.directors.directorClient', 'company.nominations.nominatedClient'])->find($clientId);
    }
