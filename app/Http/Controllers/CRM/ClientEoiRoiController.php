...
class ClientEoiRoiController extends Controller
{
    ...
    public function calculatePoints(Request $request, Admin $client): JsonResponse
    {
        try {
            ...
            $client->qualifications = \App\Models\ClientQualification::where('client_id', $client->id)->orderByRaw('finish_date DESC NULLS FIRST')->get();
            $client->experiences = \App\Models\ClientExperience::where('client_id', $client->id)->orderByRaw('job_finish_date DESC NULLS FIRST')->get();
