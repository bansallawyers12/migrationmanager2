...
class ThemeController extends Controller
{
	...
	//check authorization start	
		...
		return view('crm.holidaythemes.index',compact(['lists', 'totalData'])); 	

		//return view('crm.manageholidaytype.index');	  
	}
		...
		{	
			if(isset($id) && !empty($id)) 
			{
				...
				if(HolidayTheme::where('id', '=', $id)->exists()) 
				{
					...
					return view('crm.holidaythemes.edit', compact(['fetchedData']));
				}
				else
				{
