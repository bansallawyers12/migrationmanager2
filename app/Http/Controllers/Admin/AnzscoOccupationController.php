...
class AnzscoOccupationController extends Controller
{
    ...
    {
        return view('Admin.anzsco.index');
    }
    ...
    public function getData(Request $request)
    {
        ...
        return DataTables::of($query)
            ...
            ->addColumn('actions', function ($occupation) {
                if (!$occupation) return '';
                return view('Admin.anzsco.partials.actions', compact('occupation'))->render();
            })
    ...
    public function edit($id)
    {
        ...
        return view('Admin.anzsco.form', compact('occupation'));
    }
    ...
    {
        return view('Admin.anzsco.import');
    }
