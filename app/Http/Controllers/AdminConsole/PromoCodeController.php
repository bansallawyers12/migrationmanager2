...
class PromoCodeController extends Controller
{
	...
	public function index(Request $request)
	{
        ...
        return view('AdminConsole\.features\.promocode.index',compact(['lists', 'totalData']));
    }

	public function create(Request $request)
	{
		return view('AdminConsole\.features\.promocode.create');
	}
        ...
        if ($request->isMethod('post')) {
			...
			if(isset($id) && !empty($id)) {
				...
				if(PromoCode::where('id', '=', $id)->exists()) {
                    ...
                    return view('AdminConsole\.features\.promocode.edit', compact(['fetchedData']));
				} else {
