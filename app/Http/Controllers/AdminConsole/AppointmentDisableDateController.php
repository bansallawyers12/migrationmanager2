...
class AppointmentDisableDateController extends Controller
{
	...
	public function index(Request $request)
	{
        ...
        return view('AdminConsole\.features\.appointmentdisabledate.index',compact(['lists', 'totalData']));
    }

	public function create(Request $request)
	{
		return view('AdminConsole\.features\.appointmentdisabledate.create');
	}
        ...
        if ($request->isMethod('post')) {
			...
			if(isset($id) && !empty($id)) {
				...
				if(BookService::where('id', '=', $id)->exists()) {
                    ...
                    return view('AdminConsole\.features\.appointmentdisabledate.edit', compact(['fetchedData','weekendd','disabledatesF']));
				} else {
