...
class ClientPortalNotificationController extends Controller
{
     ...
     */
    private const CLIENT_PORTAL_NOTIFICATION_TYPES = ['message', 'stage_change', 'matter_discontinued', 'matter_reopened', 'checklist', 'document_approved', 'document_rejected', 'document_deleted', 'document_downloaded', 'detail_approved', 'detail_rejected', 'invoice_sent_to_client_app'];
