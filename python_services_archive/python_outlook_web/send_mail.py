...
def _create_ssl_context() -> ssl.SSLContext:
    """Create a robust SSL context for cross-platform compatibility."""
...
def main() -> None:
    ...
    elif isinstance(last_error, OSError) and getattr(last_error, "errno", None) == 10106:
        print("Network service initialization failed (Error 10106).")
        print("This is a networking issue. Try these solutions:")
        print("1. Check network connectivity and DNS settings")
        print("2. Verify firewall rules allow SMTP connections")
        print("3. Check if SELinux or other security modules are blocking connections")
        print("4. Try using a different network or VPN")
        print("5. Check system logs for network-related errors")
        print("\nRunning diagnostics...")
        _diagnose_network()
