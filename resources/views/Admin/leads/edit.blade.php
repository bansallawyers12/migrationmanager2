...
<div class="main-content">
	<section class="section">
		<div class="section-body">
			...
			<form action="{{ url('admin/leads/edit') }}" method="POST" name="edit-leads" autocomplete="off" enctype="multipart/form-data">
				@csrf
										...
										<div class="row">
											...
											<div class="col-4 col-md-4 col-lg-4">
												<div class="form-group"> 
													...
													<input type="text" name="last_name" value="{{ @$fetchedData->last_name }}" class="form-control" data-valid="required" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="cus_field_input">
												...
												<input type="text" name="phone" value="{{ @$fetchedData->phone }}" class="form-control tel_input" data-valid="required" autocomplete="off" placeholder="">
												@if ($errors->has('phone'))
													<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="email">Email <span style="color:#ff0000;">*</span></label>
												<input type="email" name="email" value="{{ @$fetchedData->email }}" class="form-control" data-valid="required" autocomplete="off" placeholder="">
											@if ($errors->has('email'))
												<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="att_email">Email </label>
												<input type="email" name="att_email" value="{{ @$fetchedData->att_email }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="cus_field_input">
												...
												<input type="text" name="att_phone" value="{{ @$fetchedData->att_phone }}" class="form-control tel_input" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="input-group">
												...
												<input type="text" name="visa_expiry_date" value="{{ $visa_expiry_date }}" class="form-control dobdatepicker" data-valid="" autocomplete="off" placeholder="Select Date">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											...
											<div class="input-group">
												...
												<input type="text" name="preferredIntake" value="{{ @$fetchedData->preferredIntake }}" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="passport_no">Passport Number</label>
												<input type="text" name="passport_no" value="{{ @$fetchedData->passport_no }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="address">Address</label>
												<input type="text" name="address" value="{{ $fetchedData->address }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="city">City</label>
												<input type="text" name="city" value="{{ $fetchedData->city }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
											@if ($errors->has('city'))
												<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="zip">Post Code</label>
												<input type="text" name="zip" value="{{ $fetchedData->zip }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
											@if ($errors->has('zip'))
												<span class="custom-error" role="alert">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="nomi_occupation">Nominated Occupation</label>
												<input type="text" name="nomi_occupation" value="{{ $fetchedData->nomi_occupation }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="high_quali_aus">Highest Qualification in Australia</label>
												<input type="text" name="high_quali_aus" value="{{ $fetchedData->high_quali_aus }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="high_quali_overseas">Highest Qualification Overseas</label>
												<input type="text" name="high_quali_overseas" value="{{ $fetchedData->high_quali_overseas }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-4">
										<div class="form-group"> 
											<label for="relevant_work_exp_aus">Relevant work experience in Australia</label>
												<input type="text" name="relevant_work_exp_aus" value="{{ $fetchedData->relevant_work_exp_aus }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-4">
										<div class="form-group"> 
											<label for="relevant_work_exp_over">Relevant work experience in Overseas</label>
												<input type="text" name="relevant_work_exp_over" value="{{ $fetchedData->relevant_work_exp_over }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-4">
										<div class="form-group"> 
											<label for="married_partner">If married, English score of partner</label>
												<input type="text" name="married_partner" value="{{ $fetchedData->married_partner }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
							...
							@endforeach
									...
									<div class="col-sm-3">
										<div class="form-group"> 
											<label for="tags_label">Tags/Label </label>
												<input type="text" name="tags_label" value="{{ @$fetchedData->tags_label }}" class="form-control" data-valid="" autocomplete="off" placeholder="">
									...
									<div class="col-sm-12">
										<div class="form-group float-right">
												<button type="submit" class="btn btn-primary" onClick="customValidate('edit-leads')">Save</button>
										</div>
									</div>
								</div> 
							</div>
