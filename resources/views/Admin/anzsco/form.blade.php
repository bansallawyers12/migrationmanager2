            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        <a href="{{ route('admin.anzsco.index') }}" class="btn btn-secondary btn-sm">
                ...
                <form id="occupationForm" method="POST" 
                      action="{{ isset($occupation) ? route('admin.anzsco.update', $occupation->id) : route('admin.anzsco.store') }}">
                    @csrf
                    @if(isset($occupation))
                        @method('PUT')
                    @endif
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('admin.anzsco.index') }}" class="btn btn-secondary">
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    ...
                    setTimeout(function() {
                        window.location.href = '{{ route("admin.anzsco.index") }}';
                    }, 1500);
                } else {
