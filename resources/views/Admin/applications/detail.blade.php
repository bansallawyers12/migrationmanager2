							...
							<div class="tab-content" id="clientContent" style="padding-top:15px;">
										...
										<div class="col-md-3">
											<div class="cus_sidebar">
												<div class="form-group">
													...
													<input type="text" name="applied_intake" value="" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
								...
								{{-- Removed legacy Sales Forecast section --}}
												...
												<div class="form-group">
													...
													<input type="text" name="expect_win_date" value="" class="form-control datepicker" data-valid="" autocomplete="off" placeholder="Select Date">
													<span class="span_note">Date must be in YYYY-MM-DD (2012-12-22) format.</span>
