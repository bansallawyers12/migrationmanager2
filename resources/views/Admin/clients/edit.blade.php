                                    ...
                                    @foreach($clientAddresses as $index => $address)
                                        <div class="address-entry">
                                            ...
                                            <div class="summary-item">
                                                ...
                                                <span class="summary-value">{{ $address->start_date ? date('d/m/Y', strtotime($address->start_date)) : 'Not set' }}</span>
                                            </div>
                                            <div class="summary-item">
                                                <span class="summary-label">End Date:</span>
                                                <span class="summary-value">{{ $address->end_date ? date('d/m/Y', strtotime($address->end_date)) : 'Not set' }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
                                ...
                                @foreach($clientAddresses as $index => $address)
                                    <div class="repeatable-section">
                                        ...
                                        <div class="content-grid">
                                            <div class="form-group">
                                                <label>Address</label>
                                                <textarea name="address[{{ $index }}]" rows="2" placeholder="Address">{{ $address->address }}</textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Postal Code</label>
                                                <input type="text" name="zip[{{ $index }}]" value="{{ $address->zip }}" placeholder="Postal Code">
                                            </div>
                                            <div class="form-group">
