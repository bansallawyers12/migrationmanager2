					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								<a href="{{route('admin.email.create')}}" class="btn btn-primary"><i class="fa fa-plus"></i> Create Email Template</a>
							</div>
						</div>
						<div class="card-body">
											...
											<td>
												<div class="dropdown d-inline">
													...
													<div class="dropdown-menu">
														<a class="dropdown-item has-icon" href="{{URL::to('/admin/edit_email_template/'.base64_encode(convert_uuencode(@$list->id)))}}"><i class="far fa-edit"></i> Edit</a>
