	...
	<aside id="sidebar-wrapper">
		...
		<ul class="sidebar-menu">
			...
			<li class="dropdown {{@$appointmentsclasstype}}">
				<a href="#" class="menu-toggle nav-link has-dropdown" title="Appointments"><i class="fas fa-calendar-alt"></i><span>Appointments</span></a>
            ...
            <li class="dropdown {{@$clientmanagerclasstype}}">
                <a href="#" class="menu-toggle nav-link has-dropdown" title="Clients Manager"><i class="fas fa-users"></i><span>Clients Manager</span></a>
                <ul class="dropdown-menu">
                    {{-- @if(Auth::user()->role == 1) --}}
            ...
            ?>
                <li class="dropdown {{@$clientaccountmanagerclasstype}}">
                    <a href="#" class="menu-toggle nav-link has-dropdown" title="Account Manager"><i class="fas fa-calculator"></i><span>Account Manager</span></a>
                    <ul class="dropdown-menu">
