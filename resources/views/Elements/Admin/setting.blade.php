...
<div class="custom_nav_setting">
    <ul>
        <?php
			if(Route::currentRouteName() == 'adminconsole.features.producttype.index' || Route::currentRouteName() == 'adminconsole.features.producttype.create' || Route::currentRouteName() == 'adminconsole.features.producttype.edit' || Route::currentRouteName() == 'adminconsole.features.visatype.index' || Route::currentRouteName() == 'adminconsole.features.visatype.create' || Route::currentRouteName() == 'adminconsole.features.visatype.edit' || Route::currentRouteName() == 'adminconsole.features.source.index' || Route::currentRouteName() == 'adminconsole.features.source.create' || Route::currentRouteName() == 'adminconsole.features.source.edit' || Route::currentRouteName() == 'adminconsole.features.tags.index' || Route::currentRouteName() == 'adminconsole.features.tags.create' || Route::currentRouteName() == 'adminconsole.features.tags.edit' || Route::currentRouteName() == 'adminconsole.features.workflow.index' || Route::currentRouteName() == 'adminconsole.features.workflow.create' || Route::currentRouteName() == 'adminconsole.features.workflow.edit'){
