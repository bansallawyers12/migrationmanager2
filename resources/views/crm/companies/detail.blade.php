...
<script src="{{ URL::asset('js/crm/clients/modules/invoices.js') }}?v={{ file_exists(public_path('js/crm/clients/modules/invoices.js')) ? filemtime(public_path('js/crm/clients/modules/invoices.js')) : time() }}"></script>
