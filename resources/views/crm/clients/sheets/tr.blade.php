...
<style>
    ...
    .tr-sheet-page.listing-container { 
        margin-top: 0 !important; 
        padding-top: 0 !important; 
    }
    .tr-sheet-page .listing-section {
        padding-top: 0 !important;
    }
    .tr-sheet-page .art-sheet-card {
        margin-top: 0 !important;
    }
    ...
    .tr-sheet-page .art-sheet-top-bar {
        display: flex;
        align-items: center;
    ...
    .tr-sheet-page .art-sheet-title i {
        margin-right: 8px;
        color: #005792;
    }
    .tr-sheet-page .btn-theme,
    .tr-sheet-page .btn-theme-sm {
    ...
    .tr-sheet-page .btn-theme:hover,
    .tr-sheet-page .btn-theme-sm:hover {
    ...
    .tr-sheet-page .art-sheet-filter-bar {
        display: flex;
        align-items: center;
        flex-wrap: wrap;
        gap: 12px;
    ...
    .tr-sheet-page .art-sheet-filter-bar .filter_btn {
        margin: 0;
        background: linear-gradient(135deg, #005792 0%, #004670 100%) !important;
        color: #fff !important;
    ...
    .tr-sheet-page .art-sheet-filter-bar .filter_btn:hover {
        background: linear-gradient(135deg, #004670 0%, #003a58 100%) !important;
        box-shadow: 0 2px 8px rgba(0, 87, 146, 0.2);
    }
    .tr-sheet-page .art-sheet-filter-bar .clear-filter-btn {
        margin: 0;
    ...
    .tr-sheet-page .art-sheet-filter-bar .clear-filter-btn:hover {
        background: #006a9a !important;
        text-decoration: none;
    }
    .tr-sheet-page .active-filters-badge {
        background: #ff6b6b;
        color: white;
        padding: 2px 8px;
        border-radius: 12px;
    ...
    .tr-sheet-page .comment-cell .sheet-comment-text { 
        max-height: 3.6em; 
        overflow: hidden; 
    ...
    .tr-sheet-page .checklist-status-cell .checklist-status-select { 
        min-width: 140px; 
        max-width: 180px; 
    }
    ...
    .tr-sheet-page .pin-star {
        font-size: 18px;
        cursor: pointer;
        color: #cbd5e0;
        transition: all 0.2s ease;
    }
    .tr-sheet-page .pin-star:hover {
        color: #f59e0b;
        transform: scale(1.2);
    }
    .tr-sheet-page .pin-star.pinned {
        color: #f59e0b;
        text-shadow: 0 0 8px rgba(245, 158, 11, 0.3);
    }
    .tr-sheet-page .pin-star.pinned:hover {
        color: #cbd5e0;
    }
</style>
@endsection
