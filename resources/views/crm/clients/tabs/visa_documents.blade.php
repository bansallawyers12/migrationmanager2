                                                                    ...
                                                                    <div class="dropdown-menu">
                                                                        ...
                                                                        @if (strtolower($fetch->filetype) === 'pdf')
                                                                            ...
                                                                            @if($fetch->status === 'sent')
                                                                                <a target="_blank" href="{{ route('signatures.show', $fetch->id) }}" class="dropdown-item">Check To Signature</a>
                                                                            @endif
                ...
                function handleVisaContextAction(action) {
                    ...
                    switch(action) {
                        ...
                        case 'check-signature':
                            const checkSignatureUrl = '{{ route('signatures.show', ':id') }}'.replace(':id', currentVisaContextFile);
                            window.open(checkSignatureUrl, '_blank');
                            break;
                        case 'download-signed':
                            const downloadSignedUrl = '{{ route('documents.download.signed', ':id') }}'.replace(':id', currentVisaContextFile);
