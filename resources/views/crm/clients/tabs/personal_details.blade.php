<div class="tab-pane active" id="personaldetails-tab">
                <div class="content-grid">
                    ...
                    <?php
                    $clientQualification_Info = App\Models\ClientQualification::select('level','name','qual_campus','finish_date')->where('client_id', $fetchedData->id)->orderByRaw('finish_date DESC NULLS FIRST')->get();
                    ?>
                    ...
                    <?php
                    $clientExperience_Info = App\Models\ClientExperience::select('job_title','job_country','job_start_date','job_finish_date')->where('client_id', $fetchedData->id)->orderByRaw('job_finish_date DESC NULLS FIRST')->get();
                    ?>
