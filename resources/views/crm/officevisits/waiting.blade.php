								...
								<div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="active-tab">
									<div class="table-responsive common_table" style="overflow-x: hidden; max-width: 100%;">
										<table class="table text_wrap">
											...
											<tbody class="tdata checindata">
												...
												<tr did="{{@$list->id}}" id="id_{{@$list->id}}">
												    ...
												    ?>
										                <a target="_blank" href="{{URL::to('/leads/history/'.base64_encode(convert_uuencode(@$client->id)))}}">{{@$client->first_name}} {{@$client->last_name}}</a>
										            <?php
										            }else{
										...
										<td style="white-space: initial;">
                                            ...
                                            <?php } else { ?>
                                                <a href="javascript:;" data-id="{{@$list->id}}" data-waitingtype="{{@$list->wait_type}}" class="btn btn-danger attendsessionforclient" style="">Waiting</a>
                                            <?php } ?>
